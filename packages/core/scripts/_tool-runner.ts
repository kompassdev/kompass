...
import type { Shell, ShellPromise, ToolExecutionContext } from "../tools/shared.ts";
...
export function createToolContextForDirectory(worktree: string): ToolExecutionContext {
  return {
    directory: worktree,
    worktree,
  };
