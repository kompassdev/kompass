...
- Base ref as `<base-ref>`
- Head OID as `<head-oid>`
- Viewer login as `<viewer-login>`
...
2. Use `<viewer-login>` to avoid duplicating your own prior comments
...
```
Review submitted for PR #<pr-number>
