...
Independently classifies feedback with author-type and repository-association weighting, applies and validates only supported fixes, commits, pushes, and responds with fixes, disagreements, or clarification requests. Callers select interactive or automatic review behavior.
